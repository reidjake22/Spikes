...
def create_network(
    ...
    use_timed_array = True,
):
    logger.info(f"Creating Neuron Groups (storage mode: {storage}, path: {storage_path})")
    ...
    logger.info("Creating Synapse Groups")
    ...
    logger.debug(f"Number of excitatory neurons: {num_excitatory_neurons}")
