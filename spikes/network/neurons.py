...
class NeuronType:
    def __init__(self, neuron_type="excitatory", params=None):
        ...
        default_params_excitatory = {
            ...
            'tau_ie': 2 * ms  # Synaptic time constant for inhibitory synapses onto excitatory neurons
        }
        ...
        default_params_inhibitory = {
            ...
            'tau_ei': 5 * ms,  # Synaptic time constant for excitatory synapses onto inhibitory neurons
            'tau_ii': 5 * ms  # Synaptic time constant for inhibitory synapses onto inhibitory neurons
        }
        ...
        if params is not None:
            self.params = {**default_params, **params}  # Custom parameters override defaults
        else:
    ...
    def create_neuron_layer(self, size):
        ...
        if self.neuron_type == 'excitatory' or self.neuron_type == 'input':
            neurons.tau_ee = self.params['tau_ee']  # Excitatory-excitatory time constant
            neurons.tau_ie = self.params['tau_ie']  # Inhibitory-excitatory time constant
        elif self.neuron_type == 'inhibitory':
            neurons.tau_ei = self.params['tau_ei']  # Excitatory-inhibitory time constant
            neurons.tau_ii = self.params['tau_ii']  # Inhibitory-inhibitory time constant
